...
//    func updateFilteredData(on items: [Gold]) {
//        var snapshot = NSDiffableDataSourceSnapshot<Section, Gold>()
//        snapshot.appendSections([.main])
//        snapshot.appendItems(items)
//        DispatchQueue.main.async { self.dataSource.apply(snapshot, animatingDifferences: true) }
//    }
...
extension TasksCollectionView: UICollectionViewDelegate,UICollectionViewDelegateFlowLayout {
